...
namespace Payment\Controller\Adminhtml\Action;
...
use function GingerPay\Payment\Controller\Adminhtml\Action\__;
...
class Apikey extends Action
{
    ...
    public function execute()
    {
        ...
        if (!class_exists('Payment\Library\vendor\gingerpayments\ginger-php\src\ApiClient')) {

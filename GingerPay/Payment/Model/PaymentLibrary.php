...
use Payment\Model\Api\GingerClient;
use Payment\Model\Api\UrlProvider;
use Payment\Service\Order\CustomerData;
use Payment\Service\Order\GetOrderByTransaction;
use Payment\Service\Order\OrderLines;
use Payment\Service\Order\OrderDataCollector;
use Payment\Service\Transaction\ProcessRequest as ProcessTransactionRequest;
use Payment\Service\Transaction\ProcessUpdate as ProcessTransactionUpdate;
use Payment\Model\Cache\MulticurrencyCacheRepository;
...
use function GingerPay\Payment\Model\__;
...
class PaymentLibrary extends AbstractMethod
{
    ...
    /**
     * @param php\src\ApiClient $client
     *
     * @return array
     */

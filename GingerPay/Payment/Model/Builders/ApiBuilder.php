...
use GingerPay\Payment\Model\Builders\php;
use GingerPay\Payment\Model\Builders\UrlInterface;
use GingerPay\Payment\Model\Builders\UrlProvider;
...
class ApiBuilder
{
    ...
    public function get(int $storeId = null, string $testApiKey = null)
    {
        ...
        $gingerClient = new php\src\Ginger;
